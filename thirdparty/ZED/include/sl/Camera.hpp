...
#undef GPU
    ...
    struct /*@cond SHOWHIDDEN*/SL_CORE_EXPORT/*@endcond*/ CalibrationParameters {
        ...
        float3 R; /**< \deprecated see Rt, Rotation on its own (using Rodrigues' transformation) of the right sensor. The left is considered as the reference. Defined as 'tilt', 'convergence' and 'roll'. Using a \ref Rotation, you can use \ref Rotation::setRotationVector(R) to convert into other representations.*/
        float3 T; /**< \deprecated see Rt, Translation between the two sensors. T.x is the distance between the two cameras (baseline) in the sl::UNIT chosen during sl::Camera::open (mm, cm, meters, inches...).*/
    };
    ...
    struct CameraInformation {
        ...
        CalibrationParameters calibration_parameters; /**< \deprecated Use camera_configuration.calibration_parameters instead. (Intrinsic and Extrinsic stereo parameters for rectified/undistorded images (default)).  */
        CalibrationParameters calibration_parameters_raw; /**< \deprecated Use camera_configuration.calibration_parameters_raw instead. (Intrinsic and Extrinsic stereo parameters for original images (unrectified/distorded)). */
        sl::Transform camera_imu_transform; /**< \deprecated Use sensors_configuration.camera_imu_transform instead. (IMU to Left camera transform matrix, that contains rotation and translation between IMU frame and camera frame).*/
        unsigned int camera_firmware_version = 0; /**< \deprecated Use camera_configuration.firmware_version instead. (The internal firmware version of the camera). */
        unsigned int sensors_firmware_version = 0; /**< \deprecated Use sensors_configuration.firmware_version instead. (The internal firmware version of the sensors of ZED-M or ZED2). */
        float camera_fps = 0; /**< \deprecated Use camera_configuration.fps instead to get camera FPS.  */
        Resolution camera_resolution; /**< \deprecated Use camera_configuration.resolution instead to get camera resolution.  */
    }; ///@}
...
#define ZED_SDK_BUILD_ID "19299_1ec426ed"
